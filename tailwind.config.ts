  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        depth: {
          black: "hsl(var(--depth-black))",
          charcoal: "hsl(var(--depth-charcoal))",
          smoke: "hsl(var(--depth-smoke))",
          silver: "hsl(var(--depth-silver))",
          ivory: "hsl(var(--depth-ivory))",
          red: "hsl(var(--depth-red))",
          gold: "hsl(var(--depth-gold))",
        },
      },
      fontFamily: {
